 ...
 *
 * Ref: https://github.com/google/gson/blob/gson-parent-2.8.5/gson/src/main/java/com/google/gson/annotations/JsonAdapter.java
 *
 * SH
 */
...
import com.starohub.platies.JsonDeserializer;
import com.starohub.platies.JsonSerializer;
...
/**
 * An annotation that indicates the Platies {@link TypeAdapter} to use with a class
 * or field.
 *
 ...
 * annotations take precedence over {@code PlatiesBuilder}-registered type
 ...
 * to the enclosing {@code Platies} instance.
 *
 * @since 2.3
 *
