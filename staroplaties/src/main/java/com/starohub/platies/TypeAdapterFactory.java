 ...
 *
 * Ref: https://github.com/google/gson/blob/gson-parent-2.8.5/gson/src/main/java/com/google/gson/TypeAdapterFactory.java
 *
 * SH
 */
 ...
 * multiset's type token. A {@code Platies} is passed in to {@code create} for
 * just this purpose: <pre>   {@code
 *
 *   public class MultisetTypeAdapterFactory implements TypeAdapterFactory {
 *     public <T> TypeAdapter<T> create(Platies gson, TypeToken<T> typeToken) {
 ...
 * the foundation of how Platies converts Java objects and collections. Whenever
...
public interface TypeAdapterFactory {
   ...
   * support {@code type}.
   */
  <T> TypeAdapter<T> create(Platies platies, TypeToken<T> type);
}
