 ...
 *
 * Ref: https://github.com/google/gson/blob/gson-parent-2.8.5/gson/src/main/java/com/google/gson/internal/reflect/UnsafeReflectionAccessor.java
 *
 * SH
 */

/*
 * Copyright (C) 2017 The Platies authors
 *
 ...
 */
package com.starohub.platies.internal.reflect;
  ...
  public void makeAccessible(AccessibleObject ao) {
    ...
    if (!success) {
      try {
        ...
        throw new JsonIOException("Platies couldn't modify fields for " + ao
