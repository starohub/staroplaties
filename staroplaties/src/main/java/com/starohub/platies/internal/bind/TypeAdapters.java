 ...
 *
 * Ref: https://github.com/google/gson/blob/gson-parent-2.8.5/gson/src/main/java/com/google/gson/internal/bind/TypeAdapters.java
 *
 * SH
 */
...
import com.starohub.platies.internal.LazilyParsedNumber;
...
public final class TypeAdapters {
  ...
  public static final TypeAdapterFactory TIMESTAMP_FACTORY = new TypeAdapterFactory() {
    ...
    @Override public <T> TypeAdapter<T> create(Platies platies, TypeToken<T> typeToken) {
      ...
      final TypeAdapter<Date> dateTypeAdapter = platies.getAdapter(Date.class);
  ...
  public static <T1> TypeAdapterFactory newTypeHierarchyFactory(
    ...
    return new TypeAdapterFactory() {
      ...
      @Override public <T2> TypeAdapter<T2> create(Platies platies, TypeToken<T2> typeToken) {
