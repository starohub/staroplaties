 ...
 *
 * Ref: https://github.com/google/gson/blob/gson-parent-2.8.5/gson/src/main/java/com/google/gson/internal/Primitives.java
 *
 * SH
 */
...
public final class Primitives {
  ...
  public static boolean isWrapperType(Type type) {
    return WRAPPER_TO_PRIMITIVE_TYPE.containsKey(
        $Platies$Preconditions.checkNotNull(type));
  }
