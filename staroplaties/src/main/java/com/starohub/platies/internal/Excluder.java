 ...
 *
 * Ref: https://github.com/google/gson/blob/gson-parent-2.8.5/gson/src/main/java/com/google/gson/internal/Excluder.java
 *
 * SH
 */
...
import com.starohub.platies.ExclusionStrategy;
import com.starohub.platies.FieldAttributes;
import com.starohub.platies.Platies;
import com.starohub.platies.TypeAdapter;
import com.starohub.platies.TypeAdapterFactory;
import com.starohub.platies.annotations.Expose;
import com.starohub.platies.annotations.Since;
import com.starohub.platies.annotations.Until;
...
public final class Excluder implements TypeAdapterFactory, Cloneable {
  ...
  public <T> TypeAdapter<T> create(final Platies platies, final TypeToken<T> type) {
    ...
    return new TypeAdapter<T>() {
      ...
      private TypeAdapter<T> delegate() {
        ...
        return d != null
            ? d
            : (delegate = platies.getDelegateAdapter(Excluder.this, type));
      }
    };
  }
